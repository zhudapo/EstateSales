...
- (void)selectedOk
{
    if ([self.delegate respondsToSelector:@selector(pickerDate:year:month:day:tagInt:)]) {
         [self.delegate pickerDate:self year:self.year month:self.month day:self.day tagInt:_tagNumber];
    }
